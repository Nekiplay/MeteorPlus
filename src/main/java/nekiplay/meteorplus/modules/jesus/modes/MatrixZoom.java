package nekiplay.meteorplus.modules.jesus.modes;
...
import nekiplay.meteorplus.modules.jesus.JesusMode;
import nekiplay.meteorplus.modules.jesus.JesusModes;

public class MatrixZoom extends JesusMode {
	public MatrixZoom() {
		super(JesusModes.MatrixZoom);
	}
